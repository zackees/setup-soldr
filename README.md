...
- Development branches may pin the tracked `_vender/soldr` checkout and pass `source-path: _vender/soldr`; setup-soldr keys the build on the checkout commit plus working-tree diff. Production installs remain release-asset based.
