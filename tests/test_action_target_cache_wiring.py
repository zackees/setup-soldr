...
EXPECTED_OUTPUTS = {
    ...
    "dylint-driver-path",
    "dylint-toolchain",
    "dylint-rustc-release",
    "dylint-rustc-commit-hash",
    "dylint-cache-identity",
    "dylint-output-cache-hit",
    "dylint-output-cache-key",
    "dylint-output-cache-paths",
...
EXPECTED_SOLDR_DEFAULT_VERSION = "0.8.43"
